...
for train_size, topp in [("1", "1.0"), ("10", "1.0"), ("100", "0.99"), ("1000", "0.99"), ("10000", "0.99")]:
    ...
    for index in range(20):
        fi = "all_primitives/meta_lm_hidden1024_" + str(index) + "_eval_formal_" + train_size + "_language_list_synchrony_topp" + topp + "_nsamples1000000_for_paper.log"
...
for train_size, topp in [("1", "1.0"), ("10", "1.0"), ("100", "0.99"), ("1000", "0.99"), ("10000", "0.99")]:
    ...
    for index in range(20):
        if train_size in ["1", "100", "10000"]:
            fi = "no_synchrony/meta_lm_no_sync_hidden1024_" + str(index) + "_eval_formal_" + train_size + "_language_list_synchrony_topp" + topp + "_nsamples1000000_for_paper.log"
        else:
            fi = "no_synchrony/meta_lm_no_sync_hidden1024_" + str(index) + "_eval_formal_" + train_size + "_language_list_synchrony_topp" + topp + "_nsamples1000000_matched.log"
        fscore = get_average_fscore(fi)
        if fscore is not None:
            fscores[train_size].append(fscore)
...
for train_size, topp in [("1", "1.0"), ("10", "1.0"), ("100", "0.99"), ("1000", "0.99"), ("10000", "0.99")]:
    ...
    for index in range(20):
        if train_size in ["10"]:
            fi = "no_recursion/meta_lm_no_recursion_hidden1024_" + str(index) + "_eval_formal_" + train_size + "_language_list_synchrony_topp" + topp + "_nsamples1000000_for_paper.log"
        else:
            fi = "no_recursion/meta_lm_no_recursion_hidden1024_" + str(index) + "_eval_formal_" + train_size + "_language_list_synchrony_topp" + topp + "_nsamples1000000_matched.log"
        fscore = get_average_fscore(fi)
        if fscore is not None:
            fscores[train_size].append(fscore)
...
for train_size, topp in [("1", "0.99"), ("10", "0.99"), ("100", "0.99"), ("1000", "0.99"), ("10000", "0.99")]:
    fscores[train_size] = []
    for index in range(20):
        fi = "standard/random_meta_lm_hidden1024_" + str(index) + "_eval_formal_" + train_size + "_language_list_synchrony_topp" + topp + "_nsamples1000000_for_paper.log"
        fscore = get_average_fscore(fi)
        fscores[train_size].append(fscore)
